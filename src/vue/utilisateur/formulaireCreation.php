            ...
            <div class="column is-8 box has-background-black-ter">
                ...
                <form action="<?= Conteneur::recupererService("generateurUrl")->generate("./inscription") ?>" method="post">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input id="login" name="login" class="input is-large" type="text"
                                           placeholder="rlebreton" minlength="3" maxlength="30" required>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input id="email" name="email" class="input is-large" type="email"
                                           placeholder="rlebreton@yopmail.com" maxlength="255" required>
                    ...
                    <div class="field is-horizontal">
                        <div class="field-body">
                            <div class="field">
                                <label class="label is-size-4" for="mdp">Mot de passe</label>
                                <div class="control has-icons-left">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input id="mdp2" name="mdp2" class="input is-large" type="password"
                                           ...
                                           pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*_=+\-]).{6,50}" required>
                                    <span class="icon is-small is-left"><ion-icon name="key"></ion-icon></span>
                                </div>
                            </div>
                        </div>
